    ...
    prompts: [
      {
        ...
        type: "input",
        message:
          "Which subdirectory should your utility be in? (optional, case sensitive)",
      },
      {
        name: "name",
        type: "input",
    ...
    actions: [
      {
        ...
        path: "utils/{{subdirectory}}/{{kebabCase name}}.ts",
      },
      {
        type: "add",
        templateFile: "templates/util/util.spec.ts.hbs",
        path: "utils/{{subdirectory}}/{{kebabCase name}}/{{kebabCase name}}.spec.ts",
      },
    ],
  });
